...
const LevelSelector = ({ level, setLevel }) => (
  <div className="mb-6 w-full">
    <h1 className="text-lg font-extrabold mb-4 text-[#f5f5dc] uppercase text-center">2. Choose Level</h1>
    <div className="flex justify-around flex-wrap gap-4 max-w-full overflow-hidden">
      {Object.entries(levelOptions).map(([key, { nameLevel, img }]) => (
        <div key={key} className="flex flex-col items-center gap-2 w-[6rem]">
